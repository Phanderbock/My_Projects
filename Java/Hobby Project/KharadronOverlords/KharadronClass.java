        ...
        points.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                JLabel pointsLabel = new JLabel(
                    ...
                    + "     (1) Aetheric Navigator   / 85 /    Leader   / <br>"
                    + "   (1) Arkanaut Admiral     / 125 /    Leader   / <br>"
                    + "    (1) Brokk Gurngsson    / 200 /    Leader   / Unique  <br>"
                    + "     (1) Drekki Flint     / 130 /   Leader  / <br>"
                    + " (1) Endrinmaster w/ D. Suit / 180 /    Leader   / <br>"
                    + " (1) Endrinmaster w/ Harness / 95 /    Leader   / <br>"
                    + "   (1) Bjorgen Thundrik    / 150 /    Leader   / <br>"
                    + " (4) Thundrik's Profiteers  / n/a /             / Unique, must be taken with Bjorgen <br>"
                    + "    (3)  Endrinriggers      / 120 /             / Battleline if Endrinmaster w/ D.Suit is General <br>"
                    + " (1) Grundstock Gunhauler   / 155 /             / Battleline in Barak-Urbaz <br>"
                    + " (5) Grundstock Thunderers  / 135 /             / Battleline in Barak-Nar <br>"
                    + "   (3)   Skywardens         / 105 /             / Battleline if Endrinmaster w/ D.Suit is General </html"
                    );
